...
export default function WhatsAppButton() {
  ...
  // Fade in after a short delay so it doesn't pop abruptly on page load
  useEffect(() => {
      ...
      {isVisible && (
        ...
        >
          ...
          <a
            ...
            className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110 hover:bg-[#1da851] focus:outline-none focus:ring-4 focus:ring-[#25D366]/30"
